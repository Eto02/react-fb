        ...
        return(
           <div className='container'>
                <div className='input-form'>
                    ...
                    <textarea className='input-content' id='content' onChange={this.onInputChange} cols="30" rows="10" placeholder='content'value={content}></textarea>
...
const reduxDispatch=(dispatch)=>({
    ...
    getNote: (data)=>dispatch(getDataFromApi(data)),
